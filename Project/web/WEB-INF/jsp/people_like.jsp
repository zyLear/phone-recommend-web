...
<head>
    ...
    <script src="${pageContext.request.contextPath}/javascript/people_like.js"></script>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <%--<div>--%>
                <%--<button id="likeLoadMore" type="button" class="btn btn-info btn-lg btn-block">加载更多...</button>--%>
            <%--</div>--%>
    ...
    <div class="modal-dialog modal-sm" role="document">
        ...
        <div class="modal-content" style="width: 75%; text-align: center; margin: 0 auto; width: 300px;">
            ...
            <div class="modal-body">
                <button id="removeLike" type="button" class="btn btn-info" style="width: 45%; font-size: 20px; margin-right: 5px;">＞﹏＜<br>取消收藏</button>
