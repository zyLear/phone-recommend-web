...
$(document).ready(function () {
    ...
    $('#dislike').click(function () {
        $('#modal').modal('hide');
        $.post("dislike.do",{'peopleId':currentPeopleId,'phoneId':currentPhoneId},function (data,status) {
            if(status=='success'&&data=='success') {
    ...
    forEach();
    $('#recommendLoadMore').click(function () {
        $.post("getRecommendPhoneInfoByPage.do", {peopleId: currentPeopleId,page: rcPage},
